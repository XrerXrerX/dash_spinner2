...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/jenisvoucher/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/jenisvoucher/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/jenisvoucher/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/jenisvoucher/edit/' + id);
            });
        });
