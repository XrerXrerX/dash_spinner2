    ...
    <form action="" method="POST" enctype="multipart/form-data" id="form">
        ...
        <div class="sec_form">
            ...
            <div class="list_form">
                ...
                <input type="text" id="name" name="name[]" placeholder="Masukkan Nama" {{ $disabled }} value={{ $item->name }} required>
            </div>
            <div class="list_form">
                <span class="sec_label">Divisi</span>
                <select id="divisi" name="divisi[]" {{ $disabled }}>
                    @foreach ($datawebsite as $website)
                    <option value="{{ $website->nama }}" {{ $website->nama == $item->divisi ? 'selected' : '' }}>
                        {{ $website->nama }}
                    </option>
                    @endforeach
            ...
            <div class="list_form">
                ...
                <input type="text" id="username" name="username[]" placeholder="Masukkan Username" {{ $disabled }} value={{ $item->username }} required>
            </div>
            <div class="list_form">
                <span class="sec_label">Password</span>
                <input type="password" id="password" name="password[]" placeholder="Masukkan Password Jika Ingin Mengganti Password , Kosongkan jika tidak" {{ $disabled }}>
            </div>
            <div class="list_form">
                <span class="sec_label">Konfirmasi Password</span>
                <input type="password" id="cpassword" name="cpassword" placeholder="Masukkan Konfirmasi Password" {{ $disabled }}>
            </div>
            <div class="list_form">
