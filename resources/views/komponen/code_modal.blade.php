        ...
        <div class="bar_code">
            <div class="preview_code">
                ...
                <div class="sec_box hgi-100">
                    <button class="sec_botton btn_primary triggermodal" data-target="nilai-1">Lihat Modal</button>
                </div>
                <div id="nilai-1" class="sec_modal">
                            ...
                            <div class="conten_body_modal">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="list_form">
                                        ...
                                        <select id="" name="">
                                            <option value="arwanatoto" selected="">arwanatoto</option>
            ...
            <div class="copy_code" style="max-height: 120px;">
                <h3>Code Element</h3>
                <pre><code class="language-html" id="modal-form">
                    &lt;div class="sec_box hgi-100"&gt;
                    &lt;button class="sec_botton btn_primary triggermodal" data-target="nilai-1"&gt;Lihat Modal&lt;/button&gt;
                &lt;/div&gt;
                &lt;div id="nilai-1" class="sec_modal"&gt;
                ...
                <button class="copy_element" onclick="copyElement('modal-form')">
    ...
    <div class="sec_box">
        ...
        <div class="bar_code">
            <div class="preview_code">
                <h3>Preview</h3>
                <div class="sec_box hgi-100">
                    <button class="sec_botton btn_primary triggermodal" data-target="nilai-2">Lihat Modal</button>
                </div>
            ...
            <div class="copy_code" style="max-height: 120px;">
                <h3>Code Element</h3>
                <pre><code class="language-html" id="modal-blank">
                    &lt;div class="sec_box hgi-100"&gt;
                    &lt;button class="sec_botton btn_primary triggermodal" data-target="nilai-2"&gt;Lihat Modal&lt;/button&gt;
                &lt;/div&gt;
                &lt;div id="nilai-2" class="sec_modal"&gt;
                ...
                <button class="copy_element" onclick="copyElement('modal-blank')">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-copy" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M8 8m0 2a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2z" />
                        <path d="M16 8v-2a2 2 0 0 0 -2 -2h-8a2 2 0 0 0 -2 2v8a2 2 0 0 0 2 2h2" />
