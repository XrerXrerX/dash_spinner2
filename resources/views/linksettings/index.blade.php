...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-jenisvoucher').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/linksettings/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/linksettings/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-jenisvoucher').on('click', '#add-jenisvoucher', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/linksettings/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/linksettings/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/linksettings/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/linksettings/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-jenisvoucher', function(event) {
            ...
            var url =
                "/linksettings/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/linksettings/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/linksettings/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/linksettings/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/linksettings/edit/' + id);
            });
        });
